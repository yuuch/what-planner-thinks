...
- [外连接消除与无用连接移除](phase1/outer_join_elimination.md)
...
# 附录：基础设施 (The Core)
- [等价类 (Equivalence Classes)](appendix/equivalence_classes.md)
- [路径键 (PathKeys)](appendix/pathkeys.md)
- [选择率与代价模型](appendix/selectivity_cost.md)